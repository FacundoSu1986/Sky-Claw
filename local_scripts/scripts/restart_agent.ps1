...
$GatewayProc = Start-Process node -ArgumentList "$PSScriptRoot\..\sky_claw\app\comms\telegram_gateway_node\server.js" -NoNewWindow -PassThru -ErrorAction SilentlyContinue

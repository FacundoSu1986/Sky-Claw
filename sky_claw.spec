...
datas = [
    ...
    ("sky_claw/app/gui/styles.css", "sky_claw/app/gui"),
    ("sky_claw/app/gui/assets", "sky_claw/app/gui/assets"),
    ...
    ("sky_claw/app/security/security_policy.yaml", "sky_claw/app/security"),
]
...
hiddenimports = [
    ...
    "rarfile",
    # LLM providers
    "sky_claw.app.agent.providers",
    # Web UI
    "sky_claw.app.web",
    "sky_claw.app.web.app",
    # SSL/TLS for HTTPS
    "ssl",
    "certifi",
    # SQLite
    ...
    "sky_claw.app.agent.router",
    "sky_claw.app.agent.tools",
    "sky_claw.app.comms.telegram",
    "sky_claw.app.comms.telegram_sender",
    "sky_claw.app.db.async_registry",
    "sky_claw.app.db.registry",
    ...
    "sky_claw.app.scraper.masterlist",
    "sky_claw.app.scraper.nexus_downloader",
    "sky_claw.app.security.hitl",
    "sky_claw.app.security.network_gateway",
    "sky_claw.app.security.path_validator",
    "sky_claw.app.security.sanitize",
    ...
    "sky_claw.app.orchestrator.tool_dispatcher",
    "sky_claw.app.orchestrator.tool_strategies",
    "sky_claw.app.orchestrator.tool_strategies.base",
    "sky_claw.app.orchestrator.tool_strategies.execute_loot_sorting",
    "sky_claw.app.orchestrator.tool_strategies.execute_synthesis",
    "sky_claw.app.orchestrator.tool_strategies.generate_bashed_patch",
    "sky_claw.app.orchestrator.tool_strategies.generate_lods",
    "sky_claw.app.orchestrator.tool_strategies.middleware",
    "sky_claw.app.orchestrator.tool_strategies.query_mod_metadata",
    "sky_claw.app.orchestrator.tool_strategies.resolve_conflict_patch",
    "sky_claw.app.orchestrator.tool_strategies.scan_asset_conflicts",
    ...
    # PyInstaller no lo ve en la fase de análisis. Los submodules generado

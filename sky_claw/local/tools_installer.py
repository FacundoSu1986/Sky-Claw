...
class ToolsInstaller:
    ...
    async def ensure_loot(
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-loot-{version}"),
    ...
    async def ensure_xedit(
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-xedit-{version}"),
    ...
    async def ensure_pandora(
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-pandora-{version}"),
    ...
    async def ensure_skse(
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-skse-{ed_key}"),
    ...
    async def ensure_bodyslide(
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-bodyslide-{file_info.file_id}"),
    ...
    async def _ensure_github_mod(
        ...
        *clean_on_fail* elimina exclusivamente ese staging. Un destino
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-{request_slug}-{version}"),
    ...
    async def _ensure_nexus_mod(
        ...
        *required_rel*, *required_files*, *clean_on_fail* e *install_comment*:
        ...
        async with _bajo_lock_de_instalacion(
            ...
            decision = await self._hitl.request_approval(
                request_id=new_hitl_request_id(f"install-{request_slug}-{file_info.file_id}"),
